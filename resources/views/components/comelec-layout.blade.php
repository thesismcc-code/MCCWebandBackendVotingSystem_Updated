...
<head>
    ...
    <title>@yield('title', 'MCC Voting System — Comelec')</title>
...
<aside class="sidebar">
    ...
    <div style="flex:1; overflow-y:auto; padding-bottom:16px;">
        ...
        <a href="{{ route('view.comelec-dashboard') }}" class="nav-link {{ request()->is('comelec-dashboard*') ? 'active' : '' }}">
        ...
        <a href="{{ route('view.comelec-manage-candidates') }}" class="nav-link {{ request()->is('comelec-manage-candidates*') ? 'active' : '' }}">
...
<div class="main-wrap">
    <header class="topbar">
        <div>
            ...
            <div class="topbar-sub">@yield('page-sub', 'MCC Digital Voting System — Comelec')</div>
        </div>
