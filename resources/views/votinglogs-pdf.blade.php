...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            <div class="number">{{ count(array_unique(array_column($logs, 'course'))) }}</div>
            <div class="label">Courses</div>
        </div>
        <div class="summary-item">
            <div class="number">{{ count(array_unique(array_column($logs, 'year_level'))) }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{ $log['voted_at'] ? \Carbon\Carbon::parse($log['voted_at'])->format('m-d-Y g:iA') : '—' }}
                </td>
    ...
    <div class="footer">
        ...
        <p>© {{ date('Y') }} MCC - All Rights Reserved</p>
    </div>
