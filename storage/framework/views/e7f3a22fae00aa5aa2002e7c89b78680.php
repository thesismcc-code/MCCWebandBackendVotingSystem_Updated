...
<div class="d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center gap-3">
        <a href="<?php echo e(route('view.election-control')); ?>" class="btn-back">
    ...
    <div style="background:rgba(251,191,36,.15);border:1px solid rgba(251,191,36,.3);border-radius:12px;padding:8px 16px;display:flex;align-items:center;gap:8px;">
        ...
        <span style="font-size:12px;font-weight:700;color:#fbbf24;"><?php echo e($emptyPositions); ?> position<?php echo e($emptyPositions > 1 ? 's' : ''); ?> without candidates</span>
    </div>
    <?php endif; ?>
</div>
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-number"><?php echo e($totalPositions); ?></div>
        ...
        <div class="col-md-6">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-number"><?php echo e($totalCandidates); ?></div>
                    <div class="stat-label">Total Candidates</div>
                </div>
                <a href="<?php echo e(route('view.election-control-candidate-list')); ?>" class="stat-arrow">
        ...
        <div class="table-responsive">
            <table class="tbl" id="posTable">
                ...
                <tbody id="posTableBody">
                    ...
                    <?php $candCount = $candidatesPerPosition[$position['name']] ?? 0; ?>
                    <tr class="pos-row <?php echo e($candCount === 0 ? 'warn-row' : ''); ?>" data-name="<?php echo e(strtolower($position['name'])); ?>">
                        <td style="padding-left:32px;">
                            <div class="d-flex align-items-center gap-2">
                                <span class="pos-name"><?php echo e($position['name']); ?></span>
                                <?php if($candCount === 0): ?>
                        ...
                        <td class="text-center">
                            <span class="max-vote-badge"><?php echo e($position['max_vote']); ?></span>
                        </td>
                        <td class="text-center">
                            <span class="cand-badge <?php echo e($candCount > 0 ? 'has-cands' : 'no-cands'); ?>">
                                <?php if($candCount > 0): ?>
                                ...
                                <?php endif; ?>
                                <?php echo e($candCount); ?> candidate<?php echo e($candCount !== 1 ? 's' : ''); ?>
                        ...
                        <td style="padding-left:32px;">
                            <div class="d-flex gap-2">
                                <button class="btn-edit" title="Edit"
                                    data-position-id="<?php echo e($position['id']); ?>"
                                    data-position-name="<?php echo e($position['name']); ?>"
                                    data-max-vote="<?php echo e($position['max_vote']); ?>"
                                ...
                                <button class="btn-delete" title="Delete"
                                    data-position-id="<?php echo e($position['id']); ?>"
                                    data-position-name="<?php echo e($position['name']); ?>"
                                    data-cand-count="<?php echo e($candCount); ?>"
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:520px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" action="<?php echo e(route('position.add')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width:520px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="<?php echo e(route('position.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\MCCWebandBackendVotingSystem\resources\views/posistionsetup.blade.php ENDPATH**/ ?>