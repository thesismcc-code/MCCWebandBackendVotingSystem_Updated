...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MCC Voting System — SAO'); ?></title>
...
<aside class="sidebar">
    ...
    <div style="flex:1; overflow-y:auto; padding-bottom:16px;">
        ...
        <a href="<?php echo e(route('view.sao-dashboard')); ?>" class="nav-link <?php echo e(request()->is('sao-dashboard*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('view.sao-candidate-list')); ?>" class="nav-link <?php echo e(request()->is('sao-candidate-list*') ? 'active' : ''); ?>">
            <svg class="icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            <span>Candidate List</span>
        </a>
        <a href="<?php echo e(route('view.sao-voter-participation')); ?>" class="nav-link <?php echo e(request()->is('sao-voter-participation*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('view.sao-final-results')); ?>" class="nav-link <?php echo e(request()->is('sao-final-results*') ? 'active' : ''); ?>">
...
<div class="main-wrap">
    <header class="topbar">
        <div>
            ...
            <div class="topbar-sub"><?php echo $__env->yieldContent('page-sub', 'MCC Digital Voting System — SAO'); ?></div>
        </div>
...
<?php /**PATH C:\MCCWebandBackendVotingSystem\resources\views/components/sao-layout.blade.php ENDPATH**/ ?>