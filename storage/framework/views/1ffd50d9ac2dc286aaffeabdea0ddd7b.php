...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MCC Voting System — Student'); ?></title>
...
<nav class="s-navbar">
    <div class="s-nav-inner">
        <a href="<?php echo e(route('view.student-dashboard')); ?>" class="s-brand">
            <img src="<?php echo e(asset('icons/logo_white_bg.png')); ?>" alt="MCC">
            <div>
        ...
        <div class="s-nav-right">
            <a href="<?php echo e(route('view.student-dashboard')); ?>" class="s-nav-btn" title="Dashboard">
            ...
            <a href="<?php echo e(route('view.student-profile')); ?>" class="s-avatar" title="Profile">
                <?php echo e(strtoupper(substr(session('auth_user.first_name', 'S'), 0, 1))); ?>
...
<?php /**PATH C:\MCCWebandBackendVotingSystem\resources\views/components/student-layout.blade.php ENDPATH**/ ?>