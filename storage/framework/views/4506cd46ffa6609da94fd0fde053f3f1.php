...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MCC Voting System — Comelec'); ?></title>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .sidebar {
            ...
            z-index: 50; box-shadow: 6px 0 32px rgba(0,0,0,.06);
        }
        .sidebar-logo {
        ...
        .nav-link::before {
            ...
            background: linear-gradient(135deg, #f0f7f0, #e8f5e8); opacity: 0; transition: opacity .2s;
        }
...
<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <div class="sidebar-logo-text">
            ...
            <div class="role">Comelec</div>
        </div>
    </div>

    <div style="flex:1; overflow-y:auto; padding-bottom:16px;">
        <div class="nav-section-label">Overview</div>
        <a href="<?php echo e(route('view.comelec-dashboard')); ?>" class="nav-link <?php echo e(request()->is('comelec-dashboard*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('view.comelec-manage-candidates')); ?>" class="nav-link <?php echo e(request()->is('comelec-manage-candidates*') ? 'active' : ''); ?>">
...
<div class="main-wrap">
    <header class="topbar">
        <div>
            ...
            <div class="topbar-sub"><?php echo $__env->yieldContent('page-sub', 'MCC Digital Voting System — Comelec'); ?></div>
        </div>
...
<?php /**PATH C:\MCCWebandBackendVotingSystem\resources\views/components/comelec-layout.blade.php ENDPATH**/ ?>