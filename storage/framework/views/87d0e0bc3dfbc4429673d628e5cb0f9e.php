<?php $__env->startSection('title', 'Dashboard — MCC Student Portal'); ?>

<?php $__env->startSection('content'); ?>

<?php if($resultsPublished && !$isActive): ?>
...
<div class="s-card p-12 text-center">
    ...
    <h2 class="text-xl font-extrabold text-gray-900 mb-2"><?php echo e($electionName); ?></h2>
    <p class="text-gray-500 text-sm mb-6">Results have been officially published.</p>
    <a href="<?php echo e(route('view.student-results')); ?>"
...
<div class="flex flex-wrap items-start justify-between gap-4 mb-5">
    <div>
        ...
        <h1 class="text-2xl font-extrabold text-gray-900" style="letter-spacing:-0.02em;"><?php echo e($electionName); ?></h1>
...
<div class="s-card p-5 mb-5">
    <div class="flex items-center justify-between mb-3">
        <div>
            ...
            <p class="text-3xl font-extrabold text-gray-900 mt-0.5" style="letter-spacing:-0.02em;"><?php echo e($turnoutPct); ?>%</p>
        </div>
        <div class="text-right">
            <p class="text-sm text-gray-500"><span class="font-bold text-gray-800"><?php echo e($votedCount); ?></span> voted</p>
            <p class="text-sm text-gray-500"><span class="font-bold text-gray-800"><?php echo e($totalVoters - $votedCount); ?></span> not yet</p>
        </div>
    </div>
    <div style="height:8px;background:#e8f5ee;border-radius:99px;overflow:hidden;">
        <div style="height:100%;width:<?php echo e(min($turnoutPct,100)); ?>%;background:linear-gradient(90deg,#1a5c38,#4ade80);border-radius:99px;transition:width .7s;"></div>
    </div>
    <p class="text-xs text-gray-400 mt-2"><?php echo e($totalVoters); ?> total eligible voters</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <?php $__currentLoopData = $liveResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position => $candidates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $maxVotes = max(array_column($candidates, 'votes') ?: [0]); ?>
                ...
                <div class="flex items-center justify-between mb-1.5">
                    <div class="flex items-center gap-2.5">
                        <div class="w-7 h-7 rounded-full flex items-center justify-center text-white text-[11px] font-bold flex-shrink-0"
                             style="background:<?php echo e($isLeading ? 'linear-gradient(135deg,#15803d,#16a34a)' : 'linear-gradient(135deg,#9ca3af,#6b7280)'); ?>;">
                            <?php echo e($isLeading ? '★' : strtoupper(substr($c['name'],0,1))); ?>

                        </div>
                        <span class="text-sm font-semibold text-gray-800"><?php echo e($c['name']); ?></span>
                        <?php if($isLeading): ?>
                            <span class="text-[10px] font-bold px-1.5 py-0.5 rounded-full" style="background:#dcfce7;color:#15803d;">Leading</span>
                        <?php endif; ?>
                    </div>
                    <span class="text-sm font-bold" style="color:<?php echo e($isLeading ? '#1a5c38' : '#6b7280'); ?>;"><?php echo e($c['votes']); ?> <span class="text-gray-400 font-normal text-xs">votes</span></span>
                </div>
                <div style="height:5px;background:#f0f4eb;border-radius:99px;overflow:hidden;">
                    <div style="height:100%;width:<?php echo e($pct); ?>%;background:<?php echo e($isLeading ? 'linear-gradient(90deg,#1a5c38,#4ade80)' : '#d1d5db'); ?>;border-radius:99px;transition:width .5s;"></div>
                </div>
            </div>
...
<div class="s-card p-12 text-center relative overflow-hidden">
    <img src="<?php echo e(asset('icons/logo_white_bg.png')); ?>" alt=""
...
<?php echo $__env->make('components.student-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\MCCWebandBackendVotingSystem\resources\views/student/dashboard.blade.php ENDPATH**/ ?>